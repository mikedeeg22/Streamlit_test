...
=======
    ...
    # Begin cluster process
    random_st = 21
>>>>>>> 663cfafcd4cde683667d564f2ef614e3817e4bbf
...
<<<<<<< HEAD
    ...
    with row1_1:
        ...
        st.plotly_chart(fig)
        st.markdown('Dimensionality reduction has captured **{:.1%}** of the original data variance (target: > 80%)'.format(exp_var))
...
st.sidebar.markdown('**Min_df:** When building the vocabulary, ignore terms that have a document frequency lower than '
                    'the given threshold (by proportion of documents)')
st.sidebar.markdown('**Random State:** The clustering algorithm randomly places cluster centroids to start the process, and then '
